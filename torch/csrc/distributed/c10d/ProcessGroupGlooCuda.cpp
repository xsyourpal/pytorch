...
#include <torch/csrc/distributed/c10d/ProcessGroupGlooCpu.hpp>
...
class AsyncAllreduceCUDADeviceWork : public ProcessGroupGloo::AsyncWork {
 public:
  ...
  void run() override {
    const auto& scalarType = inputs_[0].scalar_type();
...
c10::intrusive_ptr<ProcessGroupGloo::AsyncWork> makeAllreduceCPUWork(
